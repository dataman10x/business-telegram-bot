...
class SearchController
{
    ...
    {
        $text = "I could not find a match your entered text. You may consider sending us a <b>Direct Message</b> instead";
        $this->data = $data;
    ...
    {
        $text = "<b>Search Tips</b>

<b>Find Business by ID</b> Simply  enter the Business ID only, in the input field.\n
<b>Find Business by name</b> Prefix your search by the word 'name'.\n
<b>Find Business by keywords</b> Prefix your search by the word 'keyword'.\n
