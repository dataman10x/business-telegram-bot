...
class Parser
{
    ...
    public function encoder(string $data, bool $encode = true)
    {
        $res = $data;
    ...
    public function isTelegramStepwise($messageText, $prefix = 'step_')
    {
        $iStep = false;
    ...
    {
        $getCommands = config('telegram.commands');
        $cmdArr = [];
        foreach ($getCommands as $val) {
            if($val !== '' && $val !== null) {
                array_push($cmdArr, $val['botref']);
            }
        }
        return $cmdArr;
    }
    ...
    public function addDays(int $val, $date = null)
    {
        $current = $date == null? Carbon::now(): Carbon::parse($date);
        return $current->addDays($val);
    }

    public function addWeeks(int $val, $date = null)
    {
        $current = $date == null? Carbon::now(): Carbon::parse($date);
        return $current->addWeeks($val);
    }

    public function addMonths(int $val, $date = null)
    {
        $current = $date == null? Carbon::now(): Carbon::parse($date);
        return $current->addMonths($val);
    }

    public function addYears(int $val, $date = null)
    {
        $current = $date == null? Carbon::now(): Carbon::parse($date);
        return $current->addYears($val);
    }

    public function addHours(int $val, $date = null)
    {
        $current = $date == null? Carbon::now(): Carbon::parse($date);
        return $current->addHours($val);
    }

    public function addMinutes(int $val, $date = null)
    {
        $current = $date == null? Carbon::now(): Carbon::parse($date);
        return $current->addMinutes($val);
    }

    public function addSeconds(int $val, $date = null)
    {
        $current = $date == null? Carbon::now(): Carbon::parse($date);
        return $current->addSeconds($val);
    }

    public function subDays(int $val, $date = null)
    {
        $current = $date == null? Carbon::now(): Carbon::parse($date);
        return $current->subDays($val);
    }

    public function subWeeks(int $val, $date = null)
    {
        $current = $date == null? Carbon::now(): Carbon::parse($date);
        return $current->subWeeks($val);
    }

    public function subMonths(int $val, $date = null)
    {
        $current = $date == null? Carbon::now(): Carbon::parse($date);
        return $current->subMonths($val);
    }

    public function subYears(int $val, $date = null)
    {
        $current = $date == null? Carbon::now(): Carbon::parse($date);
        return $current->subYears($val);
    }

    public function subHours(int $val, $date = null)
    {
        $current = $date == null? Carbon::now(): Carbon::parse($date);
        return $current->subHours($val);
    }

    public function subMinutes(int $val, $date = null)
    {
        $current = $date == null? Carbon::now(): Carbon::parse($date);
        return $current->subMinutes($val);
    }

    public function subSeconds(int $val, $date = null)
    {
        $current = $date == null? Carbon::now(): Carbon::parse($date);
